...
const ContestRegistrationPage = () => {
  ...
  useDocumentMeta({
    title: `Đăng ký cuộc thi ${contest?.name}`,
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Thông tin chung về đội thi</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Thêm thông tin các thành viên khác trong đội (tối đa 3 thành
                viên/đội)
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              {fields.map((field, index) => (
                <div key={field.id} className="p-4 border rounded-lg space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor={`members.${index}.fullName`}>
                        Họ và tên
                      </Label>
                      <Input {...register(`members.${index}.fullName`)} />
                    </div>
                    <div>
                      <Label htmlFor={`members.${index}.studentId`}>
                        Mã sinh viên
                      </Label>
                      <Input {...register(`members.${index}.studentId`)} />
                    </div>
                    <div>
                    ...
                    <div>
                      <Label htmlFor={`members.${index}.facebookLink`}>
                        Facebook
                      </Label>
                      <Input
                        type="url"
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-start gap-2">
                ...
                <Label
                  htmlFor="agreeTerms"
                  className={!hasOpenedTerms ? "text-muted-foreground" : ""}
                >
                  Tôi đồng ý với{" "}
                  <button
                    type="button"
              ...
              {!hasOpenedTerms && (
                <p className="text-sm text-muted-foreground">
                  Bấm vào{" "}
                  <span className="font-semibold">điều khoản của cuộc thi</span>{" "}
                  để xem, sau đó bạn có thể tick đồng ý.
                </p>
              )}
            </CardContent>
          </Card>
